export default async function handler(req, res) {
  ...
  // 2. KNOWLEDGE BASE (Your Exact Data)
  ...
  // 3. ADAPTIVE & MULTILINGUAL PERSONA
  const SYSTEM_PROMPT = `
  ...
  **PHASE 2: NAME REFUSAL**
  - If they refuse the name ("No", "Skip"): Stop asking. Answer the query professionally.
  ...
  **PHASE 3: SOCIALIZING (If Name is given)**
  ...
  --- FORMATTING ---
  - Use <br> for breaks. Use <b style="color:#006064;">Bold</b> for products.
  - LINKS: Always include "View Details" links when explaining products.
  ...
  const url = `https://generativelanguage.googleapis.com/v1beta/models/gemma-3-it:generateContent?key=${apiKey}`;
